  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the ease of car rental with Cars - a comprehensive platform offering distinct dashboards for customers, sales personnel, and administrators."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the ease of car rental with Cars - a comprehensive platform offering distinct dashboards for customers, sales personnel, and administrators.`}
            </Text>
            <Box
